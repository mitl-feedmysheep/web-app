          ...
          <Card className="border-0 shadow-md shadow-primary/5">
            <CardContent className="p-0">
              <div className="flex w-full items-center gap-3 px-4 py-3.5">
                ...
                <span className="min-w-0 flex-1 text-left text-sm font-medium">알림 설정</span>
              ...
              <div data-highlight="">
                <div className="flex w-full items-center gap-3 px-4 py-3.5">
                  ...
                  <span className="min-w-0 flex-1 text-left text-sm font-medium">버그 신고 · 기능 요청 · 질문사항</span>
                  <ChevronRight className="h-4 w-4 shrink-0 text-muted-foreground" />
                </div>
              </div>
              <div className="px-4">
              ...
              <div className="flex w-full items-center gap-3 px-4 py-3.5">
                ...
                <span className="min-w-0 flex-1 text-left text-sm font-medium">앱 사용법 보기</span>
                <ChevronRight className="h-4 w-4 shrink-0 text-muted-foreground" />
              </div>
            </CardContent>
          </Card>
